...
class MappingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mapping" do
    assert_difference('Mapping.count') do
      post mappings_url, params: { mapping: { direcory: @mapping.direcory, regexstring: @mapping.regexstring } }
    end
  ...
  test "should update mapping" do
    patch mapping_url(@mapping), params: { mapping: { direcory: @mapping.direcory, regexstring: @mapping.regexstring } }
